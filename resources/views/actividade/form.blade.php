<div class="box box-info padding-1">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
        <div class="form-group">
            {{ Form::label('subsector_id') }}
            {{ Form::select('subsector_id',$subsectores, $actividade->subsector_id, ['class' => 'form-control' . ($errors->has('subsector_id') ? ' is-invalid' : ''), 'placeholder' => 'Subsector Id']) }}
