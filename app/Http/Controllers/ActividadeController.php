...
class ActividadeController extends Controller
{
    ...
    public function create()
    {
        ...
        $subsectores = Subsectore::pluck('nombre','id');
        return view('actividade.create', compact('actividade' ,'subsectores'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('actividade.edit', compact('actividade', 'subsectores'));
    }
